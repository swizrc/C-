...
;==========================================================================
                    ...
                    MOV R0, #0      ; R0.7: no turn over, R0.6: use corner LEDs, R0.0-R0.4: not pressed
                    MOV R1, #0
                    MOV R2, #0
...
CheckIncBtn:        MOV A, R0
                    JB  P0.1, IncNotPressed     ; If pressed:
                        ...
                        MOV R0, A
                        SJMP CheckIncBtnRET
IncNotPressed:      NOP                         ; Delay - consistant alarm frequency
                    NOP
...
;-----------------------------------------------
; @name: SamsMethod
; @brief: Clears Acumulator, Register R3
;-----------------------------------------------
SamsMethod:         
                    MOV A,#0
                    MOV R3,A
